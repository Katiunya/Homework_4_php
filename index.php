...
$workExperience = [
  [
    'nameOfWork' => 'Financial analyst',
    'dateStart' => 'Jan 2018',
    'dateEnd' => 'Current',
    'description' => 'Here is a description of the work of a financial analyst.'
  ],
  
  [
    'nameOfWork' => 'Big data analyst',
    'dateStart' => 'Jun 2015',
    'dateEnd' => 'Dec 2017',
    'description' => 'Here is a description of the work of a Big data analyst.'
  ],
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $workExperience[$i]['nameOfWork'];  ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $workExperience[$i]['dateStart']; ?> - 
            <?php if ($i == 0): ?>
            ...
            <p><?= $workExperience[$i]['description']; ?></p><br>
          </div>
          <?php endfor; ?>
        </div>
